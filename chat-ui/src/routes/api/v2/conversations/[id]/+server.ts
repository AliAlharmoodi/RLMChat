...
export const GET: RequestHandler = async ({ locals, params, url }) => {
	...
	return superjsonResponse({
		...
		usesRlm: ("usesRlm" in conversation ? conversation.usesRlm : undefined) ?? false,
...
export const PATCH: RequestHandler = async ({ locals, params, request }) => {
	...
	const usesRlm = body?.usesRlm as boolean | undefined;
	...
	if (usesRlm !== undefined && typeof usesRlm !== "boolean") {
		error(400, "Invalid RLM mode");
	}
