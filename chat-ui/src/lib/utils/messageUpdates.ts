...
export function isMessageRlmTraceUpdate(update: MessageUpdate): update is MessageRlmTraceUpdate {
	return update.type === MessageUpdateType.RlmTrace;
}

export function isMessageRlmTraceStatusUpdate(
	update: MessageUpdate
): update is Extract<MessageRlmTraceUpdate, { subtype: MessageRlmTraceUpdateType.Status }> {
	return isMessageRlmTraceUpdate(update) && update.subtype === MessageRlmTraceUpdateType.Status;
}

export function isMessageRlmTraceSectionUpdate(
	update: MessageUpdate
): update is Extract<MessageRlmTraceUpdate, { subtype: MessageRlmTraceUpdateType.Section }> {
	return isMessageRlmTraceUpdate(update) && update.subtype === MessageRlmTraceUpdateType.Section;
}
