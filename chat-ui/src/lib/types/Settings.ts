...
export interface Settings extends Timestamps {
	...
	/** Whether new conversations should use the RLM runtime when available. */
	rlmMode: boolean;
	/** Optional smaller/cheaper model used for recursive subcalls in RLM mode. */
	rlmSubcallModel?: string;
